...
@Component({
  selector: 'app-tatli',
  templateUrl: './tatli.component.html',
  styleUrls: ['./tatli.component.css']
})
export class TatliComponent implements OnInit {
  ...
  KayitDuzenle3(kayitt: Kayit3) {
    Object.assign(this.secKayit3, kayitt);
  }
